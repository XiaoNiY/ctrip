...
function change(a) {
    if (a == 1) {
        document.getElementById('green').setAttribute("style", "padding: 5px 15px;height: 20px;border: 1px solid blue;text-align: center;border-radius: 4px;margin-left: 20px;color: blue;margin-top: 13px;float: left;")
        ...
        document.getElementById('green').setAttribute("style", "padding: 5px 15px;height: 20px;border: 1px solid #e5e5e5;text-align: center;border-radius: 4px;margin-left: 20px;color: #676767;margin-top: 13px;float: left;")
...
function changes(a) {
    if (a == 1) {
        var picture = document.getElementById('AA5').getAttribute("src");
    } else if (a == 2) {
        var picture = document.getElementById('AA6').getAttribute("src");
    } else if (a == 3) {
        var picture = document.getElementById('AA7').getAttribute("src");
    } else if (a == 4) {
        var picture = document.getElementById('AA8').getAttribute("src");
    }


    document.getElementById('picture66').setAttribute("src", picture);
    document.getElementById('bigPic').setAttribute("src", picture);
}